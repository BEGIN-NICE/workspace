		...
		$("#username").blur(function(){
			...
			if($value != ""){
				$.post("${pageContext.request.contextPath}/UserServlet",{"method":"checkUsername","username":$value},function(data){
					if(data == 1){
						$("#s").html("<font color = 'green'>用户名可以使用</font>");
						$("#regBut").attr("disabled",false);
					}else{
						$("#s").html("<font color = 'red'>用户名已被占用</font>");
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Email">
			    </div>
			  </div>
			 <div class="form-group">

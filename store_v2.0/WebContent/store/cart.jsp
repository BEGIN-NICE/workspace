						...
						<tbody>
							...
							<c:forEach var="entry" items="${cart.map }">
								<tr class="active">
									...
									<td width="10%"><input type="text" name="count"
										value="${entry.value.count }" maxlength="4" size="10">
									</td>
									<td width="15%"><span class="subtotal">￥${entry.value.subTotal }</span>
									</td>
									<td><a href="#" class="delete" onclick="del('${entry.key}')">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a
						...
						id="clear" class="clear">清空购物车</a> <a href="${pageContext.request.contextPath }/OrderServlet?method=saveOrder"> <input

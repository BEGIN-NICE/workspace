...
<form class="form-horizontal" action="${pageContext.request.contextPath }/UserServlet" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="username" name="username" value="${remberUsername }" placeholder="请输入用户名">
    </div>
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <img id="checkImg" src="${pageContext.request.contextPath }/CheckImgServlet"/>
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="autologin" value="true" <c:if test="${ not empty autoUser }">checked</c:if>> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input type="checkbox" name="remberusername" value="true" <c:if test="${ not empty remberUsername }">checked</c:if> > 记住用户名
